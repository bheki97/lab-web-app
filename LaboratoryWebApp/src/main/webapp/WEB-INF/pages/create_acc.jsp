                    ...
                    <div class="" style="border-radius: 15px;">
                        <div class="custom-card p-5">
                            ...
                            <form action="/home/createaccount" method="post">
                                ...
                                <div class="names form-outline mb-2 ">
                                    <div><input type="number" min="0" id="form3Example1cg" name="cellno" class="form-control form-control-lg" />
                                        <label class="form-label" for="form3Example1cg">Your Cell No.</label>
                                    </div>
                                    <div class="ms-3"><input type="number" min="0" id="form3Example1cg" name="userid" class="form-control form-control-lg" />
